...
final class Strings {
  ...
  /**
   * Helper para venetravel, convierte un número en el abreviado correspondiente del mes
   *
   * @param string $mes: Número del mes
   *
   * @return string con la forma: Ene, Feb etc.
   */
  final public static function get_mes(string $mes) : string  {
    switch ($mes) {
      case '01':
      case '1':
        return 'Ene';
