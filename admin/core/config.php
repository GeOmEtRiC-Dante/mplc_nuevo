...
define('URL', 'http://localhost/mplc_nuevo/admin/');
define('APP', 'MPLC - Admin');
define('SESS_APP_ID', 'mplc_admin_app_id');
/**
...
*/
define('__ROOT__', '/mplc_nuevo/admin/');

//------------------------------------------------

# Constantes de PHPMailer
define('PHPMAILER_HOST', 'p3plcpnl0173.prod.phx3.secureserver.net');
define('PHPMAILER_USER', 'dev@ocrend.com');
define('PHPMAILER_PASS', 'Devocrend++');
